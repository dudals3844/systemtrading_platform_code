...
class ConditionList():
    def convertListToDataFrame(self, conditionList):
        conditionNameList = conditionList.split(";")[:-1]
        ...
        DataFrameToCSV.saveData(self, dataFrame=self.conditionDataFrame,
                                savePath='C:/Users/PC/PycharmProjects/systemtrading_platform/db/mystock/조건식명단.csv')
...
class ConditionData(ConditionList, ConditionFind, Line):
    def __init__(self):
